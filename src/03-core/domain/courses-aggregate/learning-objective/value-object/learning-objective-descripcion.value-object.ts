...
class LearningObjectiveDescription {
  ...
  public static create(
    value: string
  ): Result<LearningObjectiveDescription, ErrorResult> {
    ...
    return ok(new LearningObjectiveDescription(value));
  }
  ...
  private static validate(value: string = ''): {
    ...
    const lenghtValidationResult = LengthValidationBuilder.setMinLength(
      domainRules.learningObjectiveMinLength
    )
      .setMaxLength(domainRules.learningObjectiveMaxLength)
      .build()
      .validate(value);
  ...
  public equals(other: LearningObjectiveDescription): boolean {
...
export default LearningObjectiveDescription;
